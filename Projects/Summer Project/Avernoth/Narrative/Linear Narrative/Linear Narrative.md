...
For our sake, we should divide the game's narrative into several "chapters". Each chapter should have a specific theme and focus on a specific aspect of the game's story. This will allow us to structure the game's narrative in a way that is easy for the player to follow and understand.

The concept of "chapters" probably won't be directly relayed to the player, but will be more of a behind-the-scenes organizational tool for us to structure the game's narrative. However, we can still use the concept of chapters to help us communicate the game's narrative to the player in a more cohesive way.
...
Through the [Standard Journal Entries](<../../Mechanics/Journal System.md#Standard Journal Entry>), the player learns:
...
1. Journal Entry 01
2. Journal Entry 02 - Introduce idea of experiments
3. Experiment Log 01 - The first experiment log
4. Journal Entry 03
5. Experiment Log 02 - Reach the seal at the end of Avernoth
