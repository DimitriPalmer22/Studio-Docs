...
Preferably, the layout should stay pretty similar to the rough blockout shown below. The panels *can* be moved a little and resized, and the exit button can be moved somewhere else entirely.
