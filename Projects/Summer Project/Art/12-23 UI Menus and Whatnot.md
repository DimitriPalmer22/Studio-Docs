...
#### Features
- In the left panel, we see a list of all the spells currently equipped. Each item is this list is actually a button. Clicking on one of these buttons will update the right panel to show more information about that spell. Each button features, the spell's icon, name, and the type of spell it is (primary, secondary, or passive).
