...
- Designers are gonna be using Clickup A LOT more
	- I know the Relapsers are not used to using Clickup, but we need to get used to it.
	- We need it cuz we don't meet twice a week in-class anymore, nor do we get in call as frequently as we used to.
	- We need some type of something to keep track of what we're doing.
- I'm mainly doing this cuz, as a whole, The team doesn't feel anywhere near as productive as it should.
	- We've all improved so much as devs since starting workshop, but it really doesn't feel like we're completely living up to our potential.
- I wanna start coming to the meetings with the tasks PRE-WRITTEN, and then assign tasks and stuff DURING the meeting.
	- Deadlines + clarification in the meetings
	- This way, we're not just doin shit aimlessly, but actually working towards something.
	- Plus, it's good to have a backlog of things that need to get done. This way, if you are ever done with your tasks early and you still wanna contribute, you can find something to do.

### Environmental Props

- While on break, I made a list of environmental props
- CHECK THE MIRO BOARD
	- It's empty and I need your guys' help filling it out with references (this is a task for 1 or 2 people)
