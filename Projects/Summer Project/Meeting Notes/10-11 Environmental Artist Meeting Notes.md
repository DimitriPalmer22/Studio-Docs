# Descriptions of the 3 Areas in the Game

## Area 1
- Study rooms / Research hideaway
- An actual library
...
- At the end of each room, if the player has a "key", they can instead go to a "challenge room" rather than the next, basic room.
