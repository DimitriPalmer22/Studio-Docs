...
These are cutscenes that involve chaining together simple actions to create a fully cohesive sequence of events. These cutscenes will be used for things like:
- entering rooms
...
- more camera movements & camera cuts
