...
- **Pool01_Log01 Contents**: The Archmage was testing out drawing out the magic power from another tome to get mana essence in return. Results of the experiment: successful (the player will get some mana essence for completing this quest's minigame)
