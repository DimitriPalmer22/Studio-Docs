...
- While serving as part of the Musarun Empire, the Archmage created a magical device that could create magical tomes that underskilled mages could use, bolstering the Empire's military might. (Still WIP on the specifics of this device)
...
- If the Archmage was more adept at controlling his spacial magic, he would have a bigger variety of rooms and designs within Avernoth. However, he is only able to tediously recreate certain room designs that he has mastered.
...
The content of these experiment logs is heavily dependent on the actual objectives we want the player to complete. So these will come a *little bit later* once I have a very clear idea of what I can ask of the player.
