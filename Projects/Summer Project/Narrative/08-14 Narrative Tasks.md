...
2. *Allister's Primary spell question*: Question that directly determines which spell Allister will have as his primary.
	1. Flame volley (A *Primordial* Spell) - A sequence of 3 fireballs that are fired at enemies
	2. Tempest slash (A *Tempest* Spell) - A sequence of 3 slashes of wind and lighting
	3. Shadow ball (A *Twilight* Spell) - A sequence of 5 dark energy orbs that are fired at enemies
...
5. (Note: This 5th question is NOT the same one as the video. The 5th question in the video is literally just the first question again.) *Allister's Elemental Question*: Question that affects how Allister's elemental affinities for both attack and defense are randomly distributed. The elements in the game are Neutral (Raw magical energy / crystallized magic), Primordial (Fire & Earth), Glacial (Water & Ice), Tempest (Wind & lighting), and Twilight (light & dark). Each of these has both an attack stat (this boosts the damage Allister deals from spells w/ this affinity) and a resistance stat (this reduces the damage Allister takes from spells w/ this affinity).
	1. Allister gets a boost to both his Primoridal Attack and Primordial Resistance stats
	2. Allister gets a boost to both his Twilight Attack and Twilight Resistance stats
